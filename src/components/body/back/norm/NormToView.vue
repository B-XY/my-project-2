      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="大分类" prop="type1">
            <el-select v-model="ruleForm.type1" placeholder="大分类"  disabled="true">
        ...
        <el-col :span="6">
          <el-form-item label="小分类" prop="type2">
            <el-select v-model="ruleForm.type2" placeholder="大分类"  disabled="true">
        ...
        <el-col :span="12">
          <el-form-item label="关键词" prop="keys">
            <el-input v-model="ruleForm.keys"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="起草单位" prop="drillingUnit">
            <el-input v-model="ruleForm.drillingUnit"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="旧版本号" prop="oldVersion">
            <el-input v-model="ruleForm.oldVersion"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="新版本号" prop="newVersion">
            <el-input v-model="ruleForm.newVersion"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="标准摘要" prop="abstract">
            <el-input type="textarea" v-model="ruleForm.abstract"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="采用标准" prop="using">
            <el-input v-model="ruleForm.using"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="引用标准" prop="adopted">
            <el-input v-model="ruleForm.adopted"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="备注" prop="note">
            <el-input type="textarea" v-model="ruleForm.note"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="4">
        ...
        <el-col :span="12">
          <el-form-item label="中国标准分类号" prop="chinese">
            <el-input v-model="ruleForm.chinese"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="国际标准分类号" prop="international">
            <el-input v-model="ruleForm.international"  disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item>
