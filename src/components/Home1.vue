  ...
  <div id="home">
    <div class="home">
      ...
      <div class="new" v-for="item in listData">
        <div class="new_title_line com-color" v-text="item.title"></div>
        <div class="newpd">
        ...
        listData: [
          {
            ...
            carouselData: [
              ...
              {url: require('../assets/img/10.jpg'), title: '国双-检察院线产品', id: 3},
          ...
          },
          {
            ...
            carouselData: [
              /*{url: require('../assets/img/1.jpg'), title: '法官智能辅助办案系统', id: 1},*/
              {url: require('../assets/img/4.png'), title: '国双-检察院线产品', id: 2},
              {url: require('../assets/img/9.jpg'), title: '上海刑事案件智能辅助办案系统', id: 3},
              {url: require('../assets/img/12.jpg'), title: '四川省大数据智能辅助办案平台', id: 4},
              {url: require('../assets/img/7.jpg'), title: '金融纠纷一站式化解平台', id: 5}
            ]
          }
        ]
      }
